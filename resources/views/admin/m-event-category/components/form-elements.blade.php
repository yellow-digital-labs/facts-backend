<div class="mb-3"
  ...
  <label for="event_category_name" class="form-label" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{
    trans('admin.m_event_category.columns.event_category_name') }}</label>
  <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
    <input type="text" v-model="form.event_category_name" class="form-control"
      ...
      placeholder="{{ trans('admin.m_event_category.columns.event_category_name') }}"
      value="{{ $mEventCategory ? $mEventCategory->event_category_name : '' }}">
  </div>
</div>
...
<div class="form-check row"
  ...
  <div class="ml-md-auto" :class="isFormLocalized ? 'col-md-8' : 'col-md-10'">
    <input class="form-check-input" id="active" type="checkbox" v-model="form.active"
      data-vv-name="active" name="active_fake_element" {{ $mEventCategory&&$mEventCategory->active == '1'?'checked':'' }}>
    <label class="form-check-label" for="active">
      {{ trans('admin.m_event_category.columns.active') }}
    </label>
