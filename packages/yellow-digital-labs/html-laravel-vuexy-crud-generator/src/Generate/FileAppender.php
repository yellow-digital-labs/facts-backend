...
use YellowDigitalLabs\HtmlLaravelVuexyCrudGenerator\Generate\Traits\Helpers;
use YellowDigitalLabs\HtmlLaravelVuexyCrudGenerator\Generate\Traits\Names;
use YellowDigitalLabs\HtmlLaravelVuexyCrudGenerator\Generate\Traits\Columns;
...
abstract class FileAppender extends Command
{
  ...
  {
    return [['table_name', InputArgument::REQUIRED, 'Name of the existing table']];
  }
