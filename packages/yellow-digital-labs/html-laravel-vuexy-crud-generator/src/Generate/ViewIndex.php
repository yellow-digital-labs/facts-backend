<?php namespace YellowDigitalLabs\HtmlLaravelVuexyCrudGenerator\Generate;
...
class ViewIndex extends ViewGenerator
{
  ...
  public function handle()
  {
    ...
    $listingJsPath = public_path('js/admin/' . $this->modelJSName . '/Listing.js');
    $indexJsPath = public_path('js/admin/' . $this->modelJSName . '/index.js');
    $bootstrapJsPath = public_path('js/admin/index.js');
  ...
  protected function buildView()
  {
    return view('brackets/admin-generator::' . $this->view, [
      ...
      'route' => $this->route,
      'listRouteUrl' => '/'.$this->tableName.'/list',
      ...
      'export' => $this->export,
      'listingJsPath' => 'js/admin/' . $this->modelJSName . '/Listing.js',
      ...
      'hasTranslatable' =>
        $this->readColumnsFromTable($this->tableName)
          ->filter(function ($column) {
      ...
      'columns' => $this->readColumnsFromTable($this->tableName)
        ...
        ->map(function ($col) {
          ...
          if (
            $col['type'] == 'boolean' &&
            ($col['name'] == 'enabled' || $col['name'] == 'activated' || $col['name'] == 'is_published')
          ) {
            $col['switch'] = true;
          }
