...
class ViewFullForm extends ViewGenerator
{
  ...
  public function handle()
  {
    ...
    $formJsPath = public_path('js/admin/' . $this->formJsRelativePath . '/Form.js');
    ...
    $indexJsPath = public_path('js/admin/' . $this->formJsRelativePath . '/index.js');
    ...
    if (
      $this->appendIfNotAlreadyAppended($bootstrapJsPath, "import './" . $this->formJsRelativePath . "';" . PHP_EOL)
    ) {
